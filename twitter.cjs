...
module.exports.skybreach_listing = async function skybreach_listing(tweet) {
    const twitterClient = new TwitterClient({
        apiKey: process.env.SKYBREACH_TWITTER_API_KEY,
        apiSecret: process.env.SKYBREACH_TWITTER_API_KEY_SECRET,
        accessToken: process.env.SKYBREACH_TWITTER_ACCESS_TOKEN,
        accessTokenSecret: process.env.SKYBREACH_TWITTER_ACCESS_TOKEN_SECRET,
    });
